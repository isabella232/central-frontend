...
<i18n>
{
  ...
  "pt": {
    ...
    "duringDragover": {
      ...
      "dragover": "Arraste sobre a entrada na lista que você deseja substituir por esse arquivo e solte para carregá-lo.",
      "dropToPrepare": {
        "full": "Solte agora para preparar {countOfFiles} para carregar nesse formulário.",
        "countOfFiles": "{count}arquivo | {count}arquivos"
      }
    },
    "afterSelection": {
      "matched": {
        "full": [
          "{countOfFiles}pronto para carregar.",
          "{countOfFiles}prontos para carregar."
        ],
        "countOfFiles": "{count}arquivo | {count}arquivos"
      },
      "someUnmatched": {
        "full": [
          "{countOfFiles}tem nome que não foi reconhecido e será ignorado. Para carregá-lo, troque o nomes dele ou arraste individualmente sobre o destino.",
          "{countOfFiles} tem nomes que não foram reconhecidos e serão ignorados. Para carregá-los, troque os nomes deles ou arraste individualmente sobre cada destino."
        ],
        "countOfFiles": "{count} arquivo | {count}arquivos"
      },
    ...
    "duringUpload": {
      "total": "Por favor aguarde, carregando{count} arquivo: | Por favor aguarde, carregando {count}arquivos:",
      "current": "Enviando {filename}({percentUploaded})",
      "remaining": {
        "beforeLast": "{count} arquivo permanece. | {count} arquivos permanecem.",
