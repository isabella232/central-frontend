...
<i18n>
{
  ...
  "pt": {
    ...
    "header": {
      ...
      "configureClient": "Configurar o cliente"
    },
    "emptyTable": "Não existe nenhum usuário de aplicativo ainda. Você terá que criar algum para baixar formulários e enviar dados a partir do seu dispositivo.",
    "alert": {
